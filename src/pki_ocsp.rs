...
inventory::submit!
{
    ...
    let options: &'static[Opt] = &[
        ...
        Opt { long: "key",         short: "k", arg: 1, descr: "path to OCSP signing private key (can be used multiple times)" },
        Opt { long: "keyid",       short: "K", arg: 1, descr: "smartcard or TPM private key object handle (can be used multiple times)" },
        Opt { long: "cert",        short: "c", arg: 1, descr: "path to OCSP signing certificate (can be used multiple times" },
        Opt { long: "certid",      short: "X", arg: 1, descr: "smartcard or TPM certificate object handle (can be used multiple times)"  },
        Opt { long: "cacert",      short: "C", arg: 1, descr: "CA certificate (can be used multiple times" },
        Opt { long: "index",       short: "x", arg: 1, descr: "OpenSSL-style index.txt to check status of certificates" },
